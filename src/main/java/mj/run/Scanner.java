...
public class Scanner {
	...
	static {
		...
		literals.put("program", 4);
		literals.put("final", 7);
		literals.put("class", 11);
		literals.put("void", 12);
		literals.put("if", 19);
		literals.put("else", 20);
		literals.put("while", 21);
		literals.put("break", 22);
		literals.put("return", 23);
		literals.put("read", 24);
		literals.put("print", 25);
		literals.put("new", 41);
	...
	Token NextToken() {
		...
		loop: for (;;) {
			switch (state) {
				...
				case 2:
					if (ch <= '&' || ch >= '(' && ch <= '[' || ch >= ']' && ch <= 65535) {AddCh(); state = 3; break;}
					else if (ch == 92) {AddCh(); state = 6; break;}
					else {state = 0; break;}
				case 3:
					if (ch == 39) {AddCh(); state = 4; break;}
					else {state = 0; break;}
				case 4:
					{t.kind = 2; break loop;}
				case 5:
				...
				case 6:
					...
					else if (ch == 92 || ch == 'n' || ch == 'r') {AddCh(); state = 3; break;}
					else {state = 0; break;}
				case 7:
